...
<body>
  ...
  <header id="header" class="d-flex align-items-center header-inner">
    <div class="container-fluid d-flex align-items-center">
      ...
      <div id="logo" class="me-auto">
        ...
        <a href="landing.php" class="scrollto"><img src="images/banner.png" alt="" title=""></a>
      </div>

      <nav id="navbar" class="navbar order-last order-lg-0">
      <ul>
          <li><a class="nav-link scrollto" href="landing.php">Home</a></li>
      ...
      <div class="container">
        ...
        <div class="row panel">
          <div class="col-md-8" id="imgcon">
            <img src="images/fanart/2.jpg" alt="" class="img-fluid" id="big">
          </div>

          <div class="col-md-4" id="paragraph">
            <div>
              <h2 id="black">Sage and pheonix</h2>
              <p class="black">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Harum velit fuga enim autem numquam fugiat officia, qui quia quibusdam, doloribus voluptatem eum tempore quaerat sunt optio corporis exercitationem veniam. Consectetur?</p>
            </div>
          </div>
  ...
  <footer id="footer">
    <div class="footer-top">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 ">
            <img src="images/banner.png" alt="TheEvenet" class="img-fluid" >
          </div>

          <div class="col-lg-4 col-md-6 footer-links">
            <h4>Links</h4>
             <ul>
          <li><a class="nav-link scrollto active" href="landing.php">Home</a></li>
          ...
          <div class="col-lg-4 col-md-6 footer-contact">
            <h4>Contact Us</h4>
              <strong>Phone:</strong> +977 9864236214<br>
              <strong>Email:</strong> rbaz9864@gmail.com<br>
            </p>
    ...
    <div class="container">
      <div class="copyright">
       <strong>Made by:</strong>Alisha Shrestha<br>
       Deepak Gurung
      </div>
    </div>
  </footer>
